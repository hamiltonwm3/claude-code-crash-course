...
export default function HookCard({ hook }: HookCardProps) {
  ...
  return (
    <div data-testid="hook-card" className="group bg-[var(--background)] border border-[var(--border)] rounded-xl p-5 hover:border-[#d97757]/40 hover:shadow-lg hover:shadow-[#d97757]/5 transition-all duration-300 hover:-translate-y-1">
